        ...
        <div class="col-md-10">
            <div class="card border-0 shadow-lg my-4">
                <div class="card-header bg-primary">
                    <h4 class="text-white">Créer un Produit</h4>
                </div>
                <form action="{{ route('produits.store') }}" method="POST">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <input value="{{ old('libele') }}" type="text"
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input value="{{ old('prixunitaire') }}" type="number" step="0.01"
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label class="form-label h5">Stock initial</label>
